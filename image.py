...
if __name__ == "__main__":
    ...
    input_image = Image.open("test_cropped.png")
    ...
    img = cv2.imread('test_cropped.png',0)
    img_2=img.copy()
    ...
    cimg = cv2.cvtColor(img,cv2.COLOR_GRAY2BGR)
    circles = cv2.HoughCircles(img,cv2.HOUGH_GRADIENT,1,20,param1=118,param2=8,minRadius=15,maxRadius=20)
...
# draw the center of the circle
    ...
    input_image_2 = Image.open("test_cropped.png")
   # output_image_2 = Image.new("RGB", input_image_2.size)


  
    # The threshold is the percentage of random pixels to generate
    
    for x in range(input_image_2.width):
